...
window.Search = {
    ...
    performSearch() {
        ...
        // Hide details and show results when searching
        if (window.UI) {
            window.UI.autoCollapseDetails();
            window.UI.autoExpandResults();
        }
    ...
    clearSearch() {
        ...
        // Hide details and show results when clearing search
        if (window.UI) {
            window.UI.autoCollapseDetails();
            window.UI.autoExpandResults();
        }
