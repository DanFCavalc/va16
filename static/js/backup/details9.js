            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value highlighted">${vehicle.spj || ''}</div>
                    </div>
                    <div class="detail-group">
                    ...
                    <div class="detail-group">
                        ...
                        <div class="detail-value">${vehicle.natureza || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Procedimento</div>
                        <div class="detail-value">${vehicle.procedimento || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Equipe</div>
                        <div class="detail-value">${vehicle.equipe || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Nº Procedimento</div>
                        <div class="detail-value">${Utils.formatInteger(vehicle.num_procedimento)}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value highlighted">${vehicle.status || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Chave</div>
                        <div class="detail-value">${vehicle.chave || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Circunscrição</div>
                        <div class="detail-value">${vehicle.circunscricao || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Pátio</div>
                        <div class="detail-value">${vehicle.patio || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Data da Apreensão</div>
                        <div class="detail-value">${Utils.formatDetailDate(vehicle.data_apreensao)}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Última Movimentação</div>
                        <div class="detail-value">${Utils.formatDetailDate(vehicle.ultima_movimentacao)}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value">${vehicle.tipo || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Modelo</div>
                        <div class="detail-value highlighted">${vehicle.modelo || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Ano de Fabricação</div>
                        <div class="detail-value">${vehicle.ano_fabricacao || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Ano do Modelo</div>
                        <div class="detail-value">${vehicle.ano_modelo || ''}</div>
                    </div>
                    <div class="detail-group">
                    ...
                    <div class="detail-group">
                        ...
                        <div class="detail-value">${vehicle.chassi || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Placa Original</div>
                        <div class="detail-value highlighted">${vehicle.placa_original || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Placa Ostentada</div>
                        <div class="detail-value">${vehicle.placa_ostentada || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Proprietário</div>
                        <div class="detail-value">${vehicle.proprietario || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Pessoa Relacionada</div>
                        <div class="detail-value">${vehicle.pessoa_relacionada || ''}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value">${vehicle.pericia || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Protocolo</div>
                        <div class="detail-value">${Utils.formatInteger(vehicle.protocolo)}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Status da Perícia</div>
                        <div class="detail-value">${vehicle.status_pericia || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Número do Laudo</div>
                        <div class="detail-value">${Utils.formatInteger(vehicle.numero_laudo)}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">Resultado do Laudo</div>
                        <div class="detail-value">${vehicle.resultado_laudo || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">AFIS</div>
                        <div class="detail-value">${vehicle.afis || ''}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid-single">
                    <div class="detail-group">
                        ...
                        <div class="detail-value">${vehicle.obs1 || ''}</div>
                    </div>
                    <div class="detail-group">
                        <div class="detail-label">OBS2</div>
                        <div class="detail-value">${vehicle.obs2 || ''}</div>
                    </div>
                </div>
            </div>
