            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value-text">${this.formatValue(vehicle.spj)}</div>
                    </div>
                    <div class="detail-group">
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-group">
                        ...
                        <div class="detail-value-text">${this.formatValue(vehicle.status, true)}</div>
                    </div>
                    <div class="detail-group">
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-group">
                        ...
                        <div class="detail-value-text">${this.formatValue(vehicle.chassi)}</div>
                    </div>
                    <div class="detail-group">
